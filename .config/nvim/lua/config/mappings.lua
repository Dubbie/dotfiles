...
-- Repeat default is ; make it é
-- Comamnd is : make it É
-- goto mk. bol is ' make it á
-- reg spec is " make it Á
-- Command replace : with É
keyset("n", ":", "<Nop>", {
  noremap = true,
  silent = true
})
...
-- Hide search highlighting when searching
